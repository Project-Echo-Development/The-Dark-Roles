...
namespace TheDarkRoles
{
    ...
    {
        private static readonly string DENY_NAME_LIST_PATH = @"./TheDarkRoles_DATA/DenyName.txt";
        private static readonly string BAN_LIST_PATH = @"./TheDarkRoles_DATA/BanList.txt";

        [PluginModuleInitializer]
        public static void Init()
        {
            Directory.CreateDirectory("TheDarkRoles_DATA");
