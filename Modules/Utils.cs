...
namespace TheDarkRoles
{
    public static class Utils
    {
        ...
        public static void ApplySuffix()
        {
            ...
            var username = DataManager.player.Customization.Name;
            ...
            else
            {
                ...
                switch (Options.GetSuffixMode())
                {
                    case SuffixModes.None:
                        name = $"{GradientColorText(Main.ModColorNoTag, Main.ModColor2NoTag, username)}";
                        break;
                    case SuffixModes.ModName:
                    ...
                    case SuffixModes.Sleepy:
                        name = $"{GradientColorText(Main.ModColorNoTag, Main.ModColor2NoTag, "The sleepiest!")}";
                        name += $"\n\r{GradientColorText(Main.ModColorNoTag, Main.ModColor2NoTag, username)}";
                        break;
                }
            }
        ...
        {
            var folder = Directory.CreateDirectory($"{Application.persistentDataPath}/TheDarkRoles/Logs");
            if (auto)
            {
        ...
        public static string CopyLog(string path)
        {
            ...
            string fileName = $"{path}/TheDarkRoles-v{Main.PluginVersion}-{t}.log";
