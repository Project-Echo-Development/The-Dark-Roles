        ...
        public static async Task<bool> CheckRelease(bool beta = false)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        if (assets[i]["name"].ToString() == "TheDarkRoles.dll" && Constants.GetPlatformType() == Platforms.StandaloneSteamPC)
                        {
                            downloadUrl = assets[i]["browser_download_url"].ToString();
                            break;
                        }
                        if (assets[i]["name"].ToString() == "TheDarkRoles.dll" && Constants.GetPlatformType() == Platforms.StandaloneEpicPC)
                        {
                            downloadUrl = assets[i]["browser_download_url"].ToString();
                            break;
                        }
        ...
        private static void ShowPopup(string message, bool showButton = false)
        {
            if (InfoPopup != null)
            {
                ...
                if (button != null)
                {
                    ...
                    {
                        Application.OpenURL("https://github.com/The-Project-Echo/The-Dark-Roles/releases/latest");
                        Application.Quit();
                    }));
                }
            }
